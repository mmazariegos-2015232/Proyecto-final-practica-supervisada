...
@Component({
  selector: 'app-view-magazines-to-request',
  templateUrl: './view-magazines-to-request.component.html',
  styleUrls: ['./view-magazines-to-request.component.css'],
  providers: [MagazineService, UserService],
})

export class ViewMagazinesToRequestComponent implements OnInit {
